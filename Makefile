...
FLAGS := -Wall -Wextra -Wno-missing-field-initializers -Wno-unused-parameter -Wno-unused-function -Wno-cast-function-type -pipe -MMD -g -O3 -ffast-math -I$(WINPREFIX)/include -D_FILE_OFFSET_BITS=64
